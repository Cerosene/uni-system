...
public class MockDataProvider {
    ...
    public static String i18n(String key) {
        ...
        switch (key) {
            ...
            case "nav_tickets": return isEn ? "Service Tickets" : "Zgłoszenia";
            case "nav_rental": return isEn ? "Rentals" : "Wypożyczenia";


            // --- KARTY STATYSTYK STUDENTA (STUDENT STAT CARDS) ---
            case "gpa_title": return isEn ? "Current GPA" : "Aktualna Średnia";
            case "gpa_sub": return isEn ? "+0.3 since the last semester" : "+0.3 od zeszłego semestru";
            ...
            case "payments_title": return isEn ? "My Payments" : "Moje Płatności";


            // --- KARTY WYKÄŹłADOWCY (LECTURER CARDS) ---
            ...
            // --- EKRAN WNIOSKÄŹłW (APPLICATIONS VIEW) ---
            ...
            // --- EKRAN WIADOMOÄŹłCI (MESSAGES VIEW) ---
            ...
            // --- EKRAN PÄŹłATNOÄŹłCI (PAYMENTS VIEW) ---
            ...
            // --- PANEL WYKÄŹłADOWCY (LECTURER COURSES & GRADES) ---
            ...
            // --- PANEL WYKÄŹłADOWCY - WIADOMOÄŹłCI I LISTA STUDENTÄŹłW ---
            ...
            case "dash_stat_group" : return isEn ? "Course Group" : "Grupa";
            

            // Statystyki - WykÄŹładowca
            ...
            case "dash_stat_total_users": return isEn ? "Total Platform Users" : "Wszyscy uÄŹłytkownicy";
            ...
            // Przyciski nawigacyjne (WykÄŹładowca i Admin)
            ...
            case "nav_admin_tickets": return isEn ? "Tickets" : "Zgłoszenia";
            case "nav_admin_payments": return isEn ? "Payments" : "Płatności";
            ...
            case "table_name": return isEn? "Name" : "Imię i Nazwisko";
    ...
    // Specjalna klasa modelowa dla ZgÄŹłoszeÄŹł Serwisowych (Service Tickets)
    public static ObservableList<ServiceTicket> tickets = FXCollections.observableArrayList();

    static {
        // Inicjalizacja prowadzÄŹłcych
    ...
    // --- POMOCNICZA KLASA DLA ZGÄŹłOSZEÄŹł SERWISOWYCH ---
